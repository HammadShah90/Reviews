const reviews = [
    {
        ...
        img: "url('./Assets/myImage.jpg')",
        text: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minus eveniet nemo, at quibusdam facere laboriosam error a animi voluptatem placeat. Minus eveniet nemo, at quibusdam facere laboriosam animie voluptatem",
...
let reviewImg = document.querySelector(".reviewPic");
let reviewName = document.querySelector(".reviewName");
let reviewJob = document.querySelector(".reviewDes");
let reviewInfo = document.querySelector(".reviewPara");
